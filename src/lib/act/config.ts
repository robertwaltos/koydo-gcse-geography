// Auto-generated shim — re-exports from @/lib/gcse-geography/config
// This lets shared ecosystem components import from "@/lib/act/config"
import type { ExamConfig as _gcse_geography_Config } from "@/lib/gcse-geography/config";
import { EXAM_CONFIG as _raw } from "@/lib/gcse-geography/config";
