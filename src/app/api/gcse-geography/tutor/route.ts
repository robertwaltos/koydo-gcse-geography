...
const EXAM_ID = "gcse-geography";
const EXAM_DISPLAY_NAME = "GCSE Geography";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. Respond in English.

Cover Living with the Physical Environment, Challenges in the Human Environment, and Geographical Applications. Align to AQA GCSE Geography specification.
