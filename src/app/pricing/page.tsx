...
export const metadata: Metadata = {
  title: "Pricing — Gcse Geography Premium",
  description: "Unlock unlimited Gcse Geography practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=gcse-geography&cadence=annual`;
