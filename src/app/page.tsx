...
export const metadata: Metadata = {
  title: "Koydo GCSE Geography — Free Exam Prep",
  description: "Comprehensive GCSE Geography preparation. Practice tests, AI tutor, score tracking. Study aid only. Not affiliated with official examination boards.",
};
    ...
    <main className="min-h-screen">
      ...
      <section className="mx-auto max-w-5xl px-4 py-16">
        <h2 className="mb-10 text-center text-2xl font-bold text-zinc-900 dark:text-zinc-100">
          Why Koydo for GCSE Geography?
        </h2>
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {[
            { icon: "📝", title: "Practice Tests", desc: "Hundreds of practice questions matching the real GCSE Geography format." },
